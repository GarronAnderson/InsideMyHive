...
roundrect = RoundRect(5, 5, 80, 30, 4, fill=0xFFFFFF, outline=0x000000, stroke=2)
g.append(roundrect)

roundrect2 = RoundRect(95, 5, 50, 30, 4, fill=0xFFFFFF, outline=0x000000, stroke=2)
g.append(roundrect2)
...
arc = Arc(20, 230, 0, 25, arc_width=5, outline=0x0, fill=0xFF0000, x=100, y=100)
g.append(arc)
