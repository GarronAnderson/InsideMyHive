...
arc = Arc(30, 260, 90, 25, arc_width=10, outline=0x0, fill=0xFFFFFF, x=46, y=80)
g.append(arc)

val_percent = 75
val = val_percent * 2.60
arc2 = Arc(30, val, (-(val/2)+220), 25, arc_width=10, outline=0x0, fill=0x0, x=46, y=80)
g.append(arc2)

gauge = Gauge(x=150, y=80)
gauge.update(42)
